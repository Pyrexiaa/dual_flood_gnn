...
# Base Architecture
srun python test.py --config 'configs/model1_v2/config_model1_node_only_6.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model1_timestep6.pt'
srun python test.py --config 'configs/model2_v2/config_model2_node_only_6.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model2_timestep6.pt'
...
srun python test.py --config 'configs/model1_v2/config_model1_node_only_7.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model1_timestep7.pt'
srun python test.py --config 'configs/model2_v2/config_model2_node_only_7.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model2_timestep7.pt'
...
srun python test.py --config 'configs/model1_v2/config_model1_node_only_8.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model1_timestep8.pt'
srun python test.py --config 'configs/model2_v2/config_model2_node_only_8.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model2_timestep8.pt'
...
srun python test.py --config 'configs/model1_v2/config_model1_node_only_9.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model1_timestep9.pt'
srun python test.py --config 'configs/model2_v2/config_model2_node_only_9.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model2_timestep9.pt'
