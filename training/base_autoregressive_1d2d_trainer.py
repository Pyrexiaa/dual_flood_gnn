...
class BaseAutoregressive1D2DTrainer(Base1D2DTrainer):
    def __init__(self,
        ...
        assert isinstance(self.dataloader.dataset, AutoregressiveFlood1D2DDataset), 'dataset (for training) must be an instance of AutoregressiveFloodEvent1D2DDataset.'
