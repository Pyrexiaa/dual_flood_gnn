...
class Base1D2DTrainer:
    def __init__(self,
        ...
        self.node_1d_loss_weight = node_1d_loss_weight
    ...
    def _scale_1d_node_pred_loss(self, epoch: int, pred_loss: Tensor) -> Tensor:
        if epoch < self.num_epochs_dyn_loss:
            return pred_loss
        return pred_loss * self.node_1d_loss_weight
