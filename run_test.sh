...
# Base Architecture
srun python test.py --config 'configs/model1_v2/config_model1_node_only_1.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model1_timestep1.pt'
srun python test.py --config 'configs/model2_v2/config_model2_node_only_1.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model2_timestep1.pt'
srun python process_kaggle_submissions.py --timestep_to_remove 9 --model1_test_csv 'kaggle_submissions/model1_test.csv' --model2_test_csv 'kaggle_submissions/model2_test.csv' --model1_saved_event_dir 'kaggle_submissions/Model1_1' --model2_saved_event_dir 'kaggle_submissions/Model2_1' --output_file 'kaggle_submissions/node_only_1.csv'
...
srun python test.py --config 'configs/model1_v2/config_model1_node_only_2.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model1_timestep2.pt'
srun python test.py --config 'configs/model2_v2/config_model2_node_only_2.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model2_timestep2.pt'
...
srun python test.py --config 'configs/model1_v2/config_model1_node_only_3.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model1_timestep3.pt'
srun python test.py --config 'configs/model2_v2/config_model2_node_only_3.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model2_timestep3.pt'
...
srun python test.py --config 'configs/model1_v2/config_model1_node_only_4.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model1_timestep4.pt'
srun python test.py --config 'configs/model2_v2/config_model2_node_only_4.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model2_timestep4.pt'
...
srun python test.py --config 'configs/model1_v2/config_model1_node_only_5.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model1_timestep5.pt'
srun python test.py --config 'configs/model2_v2/config_model2_node_only_5.yaml' --model 'DUALFloodGNNNode1D2D' --model_path 'saved_models/model2_timestep5.pt'
