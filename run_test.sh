...
srun python process_kaggle_submissions.py --timestep_to_remove 8 --model1_test_dir 'data/model1/test' --model2_test_dir 'data/model2/test' --model1_saved_event_dir 'kaggle_submissions/Model1_1' --model2_saved_event_dir 'kaggle_submissions/Model2_1' --output_file 'kaggle_submissions/node_only_1.csv'
